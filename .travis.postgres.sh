...
time curl -sSL "http://www.dropbox.com/s/ioj1mqc76o05lbe/test_data_for_chisel.sql.gz?dl=1" | pigz -dc | psql postgres://postgres@localhost/postgres > /tmp/restore.log 2>&1 || cat /tmp/restore.log
