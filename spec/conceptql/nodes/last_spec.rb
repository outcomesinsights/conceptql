...
describe ConceptQL::Operators::Last do
  it 'behaves itself' do
    ConceptQL::Operators::Last.new.must_behave_like(:evaluator)
  end

  it 'should have occurrence pegged at -1' do
    ConceptQL::Operators::Last.new.occurrence.must_equal(-1)
  end

  describe 'occurrence set to -1' do
    subject do
      ConceptQL::Operators::Last.new(StreamForOccurrenceDouble.new).query(Sequel.mock(host: 'postgres')).sql
    end
