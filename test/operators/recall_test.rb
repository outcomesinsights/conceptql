    ...
    query(
      ...
      ["after",
       {:left=>["during",
                ...
                :right=>["time_window",
                         ["first",
                          ["icd9", "203.0x", {:label=>"Meyloma Dx", :annotation=>{:counts=>{:condition_occurrence=>{:rows=>0, :n=>0}}, :warnings=>[["invalid source code", "203.0x"]]}, :name=>"ICD-9 CM"}],
                          {:annotation=>{:counts=>{:condition_occurrence=>{:rows=>0, :n=>0}}}}],
       ...
       :right=>["union",
                ...
                ["occurrence",
                 ["during", {:left=>["cpt", "84156", "84166", "86335", "84155", "84165", "86334", "83883", "81264", "82784", "82785", "82787", "82040", "82232", "77074", "77075", "83615", {:label=>"Other Tests", :annotation=>{:counts=>{:procedure_occurrence=>{:rows=>0, :n=>0}}}, :name=>"CPT"}],
                             :right=>["time_window", ["recall", "Qualifying Meyloma Dx", {:annotation=>{:counts=>{:invalid=>{:rows=>0, :n=>0}}, :errors=>[["no matching label"]]}}], {:start=>"-90d", :end=>"0", :label=>"Meyloma 90-day Lookback", :annotation=>{:counts=>{:invalid=>{:rows=>0, :n=>0}}, :errors=>[["wrong option format", "end"]]}}], :annotation=>{:counts=>{:procedure_occurrence=>{:rows=>0, :n=>0}}}}],
                 2,
